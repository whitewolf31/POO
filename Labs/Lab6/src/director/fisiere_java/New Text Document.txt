...
% This example shows how to formulate and solve three different types of
% differential equations using MATLAB(R). MATLAB offers several numerical
% algorithms to solve a wide variety of differential equations.  
