...
public class Test {
    public static void main(String args[]) {
        ...
        System.out.println(ListUtil.filter(element -> element % 2 == 0, list));
        ...
        Function<ArrayList<Integer>,Function<Integer,ArrayList<Integer>>> append = element -> (Function<Integer, ArrayList<Integer>>) a -> {
            element.add(a);
            return element;
        };
        System.out.println(ListUtil.foldr(append, new ArrayList<Integer>(), list));
